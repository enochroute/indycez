...
foreach($dataArr as $val){
	mysqli_query($con,"INSERT INTO distribucion_territorial SET superficie = '" . mysqli_real_escape_string($con, $val['0']) . "', poblacion = '" . mysqli_real_escape_string($con, $val['1']) ."'");
