...
foreach($dataArr as $val){
	mysqli_query($con,"INSERT INTO salud SET poblacion_afiliada = '" . mysqli_real_escape_string($con, $val['0']) . "', seguro_popular = '" . mysqli_real_escape_string($con, $val['1']) . "', imss = '" . mysqli_real_escape_string($con, $val['2']) . "', issstes = '" . mysqli_real_escape_string($con, $val['3']) . "', pemex_defensa = '" . mysqli_real_escape_string($con, $val['4']) ."', seguro_privado = '" . mysqli_real_escape_string($con, $val['5']) ."', otra_afiliacion = '" . mysqli_real_escape_string($con, $val['6']) ."'");
