...
foreach($dataArr as $val){
    ...
    if($fila["nombre_region"]==mysqli_real_escape_string($con, $val['0'])){
        $id_region=$fila["id_region"];
         mysqli_query($con,"INSERT INTO municipios SET id_region = '" . $id_region . "', nombre_municipio = '" .strtolower(mysqli_real_escape_string($con, $val['1'])) ."',
     clave5 = '" . mysqli_real_escape_string($con, $val['2']) ."'");
    }
    else{
