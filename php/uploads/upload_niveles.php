...
foreach($dataArr as $val){
	mysqli_query($con,"INSERT INTO niveles SET nombre_nivel = '" . strtolower(mysqli_real_escape_string($con, $val['0'])) . "', descripcion_nivel = '" . mysqli_real_escape_string($con, $val['1']) ."'");
