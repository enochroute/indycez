          ...
          <div class="col-md-11">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <div class="checkbox-list">
                    <label><input type="checkbox" value="16" id="chkMigracion" <?php if(in_array(16,$array_temas)){ echo "checked"; } if ($_SESSION['perfil']!=1) { echo " disabled='disabled'"; } unset($array_temas)?>> Migración </label>
                  </div>
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  <div class="checkbox-list">
                    <label><input type="checkbox" value="17" id="chkODS" <?php if(in_array(17,$array_temas)){ echo "checked"; } if ($_SESSION['perfil']!=1) { echo " disabled='disabled'"; } unset($array_temas)?>> ODS </label>
                  </div>
                </div>
              </div>
            </div>
