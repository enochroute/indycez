    ...
    var M = function (g) {
        ...
        function M(a) {
            var b = p.defaults.oLanguage,
                c = a.sZeroRecords;
            !a.sEmptyTable && (c && "No existen registros disponibles" === b.sEmptyTable) && D(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && (c && "Cargando..." === b.sLoadingRecords) && D(a, a, "sZeroRecords", "sLoadingRecords");
        ...
        function A(a, b, c, d) {
            var c = a.aoColumns[c],
                e = a.aoData[b]._aData,
                f = c.fnGetData(e, d);
            if (f === l) return a.iDrawError != a.iDraw && null === c.sDefaultContent && (O(a, 0, "Solicitud de parametro desconocido " + ("function" == typeof c.mData ? "{function}" : "'" + c.mData + "'") + " para la fila" + b, 4), a.iDrawError = a.iDraw), c.sDefaultContent;
